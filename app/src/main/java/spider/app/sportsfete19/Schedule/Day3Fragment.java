...
public class Day3Fragment extends Fragment implements Callback<List<EventDetailsPOJO>>, SwipeRefreshLayout.OnRefreshListener{
    ...
    Day3EventsDetailRecyclerAdapter eventRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_day_3, container, false);
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if(getActivity()!=null) {
            ...
            recyclerView = (RecyclerView) getActivity().findViewById(R.id.day_3_recycler_view);
            ...
            eventRecyclerAdapter = new Day3EventsDetailRecyclerAdapter(filter_eventList, getActivity());
            recyclerView.setAdapter(eventRecyclerAdapter);

            swipeRefreshLayout = (SwipeRefreshLayout) getActivity().findViewById(R.id.day_3_swipe_to_refresh);
...
*/
            ...
            if (bundle == null) {
                if (bundle == null) {
                    ...
                    Date gmt = null;
                    try {
                        gmt = formatter.parse("2018-03-17T18:23:20+0000");
    ...
    public void onRefresh() {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "Day 3 Schedule fetched");
    ...
    public void onResume(){
        ...
        filter2.addAction("scroll_to_top2");
