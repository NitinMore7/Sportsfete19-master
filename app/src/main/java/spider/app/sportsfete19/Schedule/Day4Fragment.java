 ...
 */
public class Day4Fragment extends Fragment implements Callback<List<EventDetailsPOJO>>, SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if(getActivity()!=null) {
            ...
            recyclerView = (RecyclerView) getActivity().findViewById(R.id.day_4_recycler_view);
            ...
            eventRecyclerAdapter = new Day4EventsDetailRecyclerAdapter(filter_eventList, getActivity());
            recyclerView.setAdapter(eventRecyclerAdapter);

            swipeRefreshLayout = (SwipeRefreshLayout) getActivity().findViewById(R.id.day_4_swipe_to_refresh);
...
*/
            ...
            if (bundle == null) {
                if (bundle == null) {
                    ...
                    Date gmt = null;
                    try {
                        gmt = formatter.parse("2018-03-18T18:23:20+0000");
    ...
    public void onResume(){
        ...
        filter2.addAction("scroll_to_top3");
